...
import ts from "../../../.runs/g006/pi/node_modules/typescript/lib/typescript.js";

const containingFile = resolve("spikes/pi-runtime/g006/public-type-smoke.ts");
const options = {
...
const expected = new Map([
	...
	["@earendil-works/pi-ai/providers/faux", "/packages/ai/dist/providers/faux.d.ts"],
]);
