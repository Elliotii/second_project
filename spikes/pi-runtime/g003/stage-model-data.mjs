...
const tarballPath = resolve(projectRoot, ".runs/g003/source/earendil-works-pi-ai-0.82.1.tgz");
const stagingRoot = resolve(projectRoot, ".runs/g003/staging");
const stagedDataRoot = resolve(stagingRoot, "package/dist/providers/data");
const targetDataRoot = resolve(projectRoot, ".runs/g003/pi/packages/ai/src/providers/data");
const evidenceRoot = resolve(projectRoot, ".runs/g003/evidence");
