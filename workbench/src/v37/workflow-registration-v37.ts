...
import { deriveRegistryTrustRootDigestV37, loadHistoricalRegisteredCaseFromHostRegistryV37, loadRegisteredCaseFromHostRegistryV37 } from "./host-registry-v37.ts";
...
export function loadWorkflowRegistrationV37(options: { projectRoot: string; dataRoot: string; workflowId: string; allowHistoricalReadOnly?: boolean }): { loadedCase: LoadedRegisteredCaseV37; workflow: WorkflowRegistrationV37; primary: TaskInstanceV37; follow_up: TaskInstanceV37 } {
	...
	const loadedCase = options.allowHistoricalReadOnly && workflow.manifest_version === 1
		? loadHistoricalRegisteredCaseFromHostRegistryV37({ projectRoot: options.projectRoot, caseId: workflow.case_id, manifestVersion: workflow.manifest_version, manifestBodyDigest: workflow.manifest_body_digest, registrationDigest: workflow.registration_digest })
		: loadRegisteredCaseFromHostRegistryV37({ projectRoot: options.projectRoot, caseId: workflow.case_id, allowDisabledHistorical: options.allowHistoricalReadOnly });
