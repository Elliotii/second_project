...
const routes: Record<WorkflowStageV37G3A, WorkflowActionIdV37G3A[]>={ready_for_primary:["run_primary"],ready_for_recovery:["run_recovery"],no_recovery_needed:[],recovery_inconclusive:[],ready_for_recovery_confirmation:["confirm_recovery_evidence"],ready_for_recovery_admission:["request_recovery_admission"],ready_for_candidate:["produce_candidate"],ready_for_regression:["run_regression"],candidate_rejected:[],ready_for_follow_up:["run_follow_up"],ready_for_follow_up_confirmation:["confirm_follow_up_evidence"],ready_for_follow_up_admission:["request_follow_up_admission"],ready_for_assessment:["assess_state"],complete:[]};
function deriveStage(receipts:WorkflowTransitionReceiptV37G3A[], validatePrimary:(ref:{kind:string;id:string;digest:string})=>"no_recovery_needed"|"ready_for_recovery"|"recovery_inconclusive"):WorkflowStageV37G3A {
