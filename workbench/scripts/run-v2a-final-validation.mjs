...
if (!existsSync(resolve(evidenceRoot, "EVIDENCE_INDEX.md"))) throw new Error("line-byte-corrected V2-A Evidence Index is missing");
...
const runId = "v2a-line-byte-corrected-authoritative-final-source-a-pass-b-fail";
...
const summaryRef = writeOnceJson(evidenceRoot, "FINAL_SOURCE_VALIDATION.json", {
	schema_version: "v2a-line-byte-final-source-validation-v1",
	run_id: runId,
