...
test("fixed profile loads exact effective and parent execution identities and rejects caller override", () => {
	...
	assert.equal(loaded.profile.follow_up_execution_profile_digest, "cfb6c08f3cd3ee566f709a69db49761f49cfddcd35bfceaa2428a72fbc5131b7");
