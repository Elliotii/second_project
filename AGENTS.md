...
This repository is building an Agent Harness Reliability Workbench. V0-A, V0-B and V0-C are closed and accepted, so the minimal usable V0 Workbench is complete. V1-A is closed and accepted with `PASS_V1_A_DETERMINISTIC_SUBSTRATE`; its independently re-audited Implementation Baseline is `784bd1ec06c2aa9ed554a7da661bdf582097bcdf`. V1-B is the active Goal under the accepted `V1_B_GOAL_CONTRACT.md`. Its original Stage 2 first cell paused with unknown usage/cost and remains immutable historical evidence. The accepted pause-path correction sequence, including the user's one-time P1-004 micro-correction exception, is complete: final Candidate `6a4f6529c4cb2a3e5c726d3bc8cf6beb515b720e`, tree `7ab79aa4073baab1c7570424701ebf1302b34837`, passed `PASS_FOCUSED_V1_B_P1_004_REAUDIT`. No fourth correction is authorized. The frozen replacement Manifest ID is `4f04542ea59b59110e2d9d62e08067932bf868884e05c153cd5a6bed08575b29`; its write-once sequence authority ID is `c58112fff77b0836a44668395d6ab97ece10996583254c9029c143ab84e01bd1`. A fresh no-source-edit Stage 2 Session may run that replacement Pilot from the resulting replacement Execution Baseline, one cell at a time, with USD 0.10 conservative prior debit, USD 1.90 replacement actual-cost cap, at most 25 initial starts across original plus replacement Pilots and at most eight replacement child Attempts. Historical evidence is immutable; no same-Run retry, fallback, second replacement or automatic replacement is allowed. V2 remains the Portfolio North Star and is not authorized.
