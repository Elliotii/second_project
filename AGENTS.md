...
> Preserve the invalid pair and do not retry or relabel it. Any Goal 2.5 requires a fresh
> bounded diagnosis, Main review, user-accepted Contract and separate Activation.
