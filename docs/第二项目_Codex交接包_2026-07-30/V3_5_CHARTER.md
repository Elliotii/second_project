...
```yaml
status: accepted_goal_1_closed_goal_2_closed_inconclusive_goal_2_5_audit_findings_corrected_hit_recheck_pending
date: 2026-08-09
...
goal_2_5_focused_audit_hit_recheck: pending_same_audit_session
